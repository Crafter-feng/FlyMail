...
.account-tabs::-webkit-scrollbar { height: 3px; }
.account-tabs::-webkit-scrollbar-track { background: transparent; }
.account-tabs::-webkit-scrollbar-thumb { background: var(--border-color); border-radius: 3px; }
...
.account-icon.sina { background: #fff; }
